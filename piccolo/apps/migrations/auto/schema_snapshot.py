...
class SchemaSnapshot:
    ...
    def _apply_change_table_schemas(
        ...
        for change_table_schema in (
            manager.operations.table_operations.change_table_schemas
        ):
            for table in tables:
    ...
    def _apply_rename_columns(
        ...
        rename_columns = manager.operations.column_operations.rename_columns
        for rename_column in rename_columns.for_table_class_name(
            table.class_name
        ):
